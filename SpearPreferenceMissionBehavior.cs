...
namespace SpearPreference
{
    public class SpearPreferenceMissionBehavior : MissionBehavior
    {
        ...
        public override void AfterStart()
        {
            ...
            {
                AppDomain.CurrentDomain.GetAssemblies().SelectMany(assembly => assembly.GetTypes()).FirstOrDefault(type => type.FullName == "RBMAI.StanceLogic")?.GetField("timeToUpdateAgents", BindingFlags.NonPublic | BindingFlags.Static)?.SetValue(null, float.PositiveInfinity);
            }
        }
